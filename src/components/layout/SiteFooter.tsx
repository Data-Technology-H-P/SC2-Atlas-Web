      ...
      <div className="container mx-auto px-4">
                  ...
                  <a
                    ...
                    onClick={() =>
                      trackEvent(
                        ...
                        'Data Technology H&P',
                        undefined,
                        { label: 'Data Technology H&P', location: 'footer' },
                      )
                    }
        ...
        <div className="mt-4 pt-4 border-t border-white/5 flex flex-col sm:flex-row justify-center items-center gap-2 text-xs text-gray-400">
          <Link
            href="/privacy"
            onClick={() =>
              trackEvent('footer_legal_link_clicked', 'engagement', 'privacy', undefined, {
                link: 'privacy',
                language: locale,
              })
            }
          ...
          <Link
            href="/terms"
            onClick={() =>
              trackEvent('footer_legal_link_clicked', 'engagement', 'terms', undefined, {
                link: 'terms',
                language: locale,
              })
            }
          ...
          <Link
            href="/disclaimer"
            onClick={() =>
              trackEvent('footer_legal_link_clicked', 'engagement', 'disclaimer', undefined, {
                link: 'disclaimer',
                language: locale,
              })
            }
